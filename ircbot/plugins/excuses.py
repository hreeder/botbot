...
excuses = [
    ...
    'Just pick up the phone and give modem connect sounds. "Well you said we should get '
    'more lines so we don\'t have voice lines."',
    'Quantum dynamics are affecting the transistors',
    'Police are examining all internet packets in the search for a narco-net-trafficker',
    'We are currently trying a new concept of using a live mouse.  Unfortunately, one has '
    'yet to survive being hooked up to the computer.....please bear with us.',
    ...
    "Fluorescent lights are generating negative ions. If turning them off doesn't work, take them out "
    "and put tin foil on the ends.",
    'High nuclear activity in your area.',
    "What office are you in? Oh, that one.  Did you know that your building was built over the universities first "
    "nuclear research site? And wow, aren't you the lucky one, your office is right over where the core is buried!",
    ...
    'Too many little pins on CPU confusing it, bend back and forth until 10-20% are neatly removed. Do _not_ '
    'leave metal bits visible!',
    ...
    'Due to Federal Budget problems we have been forced to cut back on the number of users able to '
    'access the system at one time. (namely none allowed....)',
    ...
    'Netscape has crashed', 'The cord jumped over and hit the power switch.', 'It was OK before you touched it.',
    'Bit rot', 'U.S. Postal Service', 'Your Flux Capacitor has gone bad.',
    'The Dilithium Crystals need to be rotated.', 'The static electricity routing is acting up...',
    "Traceroute says that there is a routing problem in the backbone.  It's not our problem.",
    'The co-locator cannot verify the frame-relay gateway to the ISDN server.',
    'High altitude condensation from U.S.A.F prototype aircraft has contaminated the primary subnet '
    'mask. Turn off your computer for 9 days to avoid damaging it.',
    'Lawn mower blade in your fan need sharpening', 'Electrons on a bender', 'Telecommunications is upgrading.',
    'Telecommunications is downgrading.', 'Telecommunications is downshifting.',
    "Hard drive sleeping. Let it wake up on it's own...", 'Interference between the keyboard and the chair.',
    ...
    "Your Pentium has a heating problem - try cooling it with ice cold water.(Do not turn off your "
    "computer, you do not want to cool down the Pentium Chip while he isn't working, do you?)",
    ...
    'building or they shoot the sysadmin. Poor misguided fools.',
    ...
    'The Internet is being scanned for viruses.', "Your computer's union contract is set to expire at midnight.",
    'Bad user karma.', '/dev/clue was linked to /dev/null', 'Increased sunspot activity.',
    ...
    'It is a layer 8 problem', 'The math co-processor had an overflow error that leaked out and shorted the RAM',
